...
import com.example.rim.Geto_Ticket.UI.ui_tools.ScreenUtils;

/**
 * Created by rim on 01/04/17.
 */

public class QrCodeFinderView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        // You need to call the following method to execute the onDraw method
        setWillNotDraw(false);
        LayoutInflater inflater = LayoutInflater.from(context);
        RelativeLayout relativeLayout = (RelativeLayout) inflater.inflate(R.layout.qrcode_layout, this);
    ...
    /**
     * Draw the focus frame, white
     *
     * @param canvas
     * @param rect
     */
    private void drawFocusRect(Canvas canvas, Rect rect) {
        // Draw the focus box (black)
    ...
    private void drawLaser(Canvas canvas, Rect rect) {
        // Draw a fixed line in the focus frame (red)
        mPaint.setColor(mLaserColor);
